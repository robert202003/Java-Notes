...
## 2.ConcurrentHashMap实现原理（难度：★★★★）
待补充......

## 3.ArrayList实现原理、扩容机制（难度：★★★）
待补充......

## 4.LinkedList实现原理、扩容机制（难度：★★★）
待补充......

## 5.ArrayList和LinkedList的区别?（难度：★★）
最明显的区别是 ArrrayList底层的数据结构是数组，支持随机访问，而 LinkedList 的底层数据结构是双向循环链表，不支持随机访问。使用下标访问一个元素，ArrayList 的时间复杂度是 O(1)，而 LinkedList 是 O(n)。

待补充......
## 6.synchronized实现原理（难度：★★★★）
...
## 10.ReentrantLock实现原理（难度：★★★★）
待补充......

## 11.ReentrantReadWriteLock原理（难度：★★★★）

## 12.synchronized和ReentrantLock的区别（难度：★★★）
...
## 13.ThreadLocal实现原理和内存泄露（难度：★★★）
待补充......

## 14.ThreadLocalRandom原理（难度：★★★）
待补充......
...
## 24.CyclicBarrier原理和使用（难度：★★★★）

## 25.Semaphore原理和使用（难度：★★★★）

## 26.ThreadPoolExecutor线程池核心参数和原理（难度：★★★）

## 27.CompletableFuture使用

## 28.ConcurrentLinkedQueue原理（难度：★★★★）

## 29.LinkedBlockingQueue原理（难度：★★★★）

## 30.ArrayBlockingQueue原理（难度：★★★★）

## 31.PriorityBlockingQueue原理（难度：★★★★）

## 32.DelayQueue原理（难度：★★★★）

## 33.SynchronousQueue（难度：★★★★）

## 34.LinkedTransferQueue（难度：★★★★）

## 35.LinkedBlockingDeque（难度：★★★★）

## 36.讲讲java中的反射？

## 37.反射中，Class.forName和classloader的区别（难度：★★）
...
## 39.Java中父类与子类静态代码块、非静态代码块、构造函数的加载顺序（难度：★★）
...
## 40.Comparator和Comparable的区别?（难度：★）
...
## 44.使用final关键字修饰一个变量时，是引用不能变，还是引用的对象不能变？（难度：★）
